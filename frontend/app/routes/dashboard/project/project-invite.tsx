...
import { useAcceptProjectInviteByTokenMutation } from '@/hooks/use-project';
...
//   const token = searchParams.get("token");
  ...
  const { mutate, isPending: isVerifying } = useAcceptProjectInviteByTokenMutation();
              ...
              isVerifying ? (
                ...
                <>
                  ...
                  <p className="text-sm text-gray-500">
                    You are added to Project Team successfully.
                  </p>
